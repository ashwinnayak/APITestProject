...
public class stepDefLibrary extends JSONBuilder {
    ...
    // Post op on Transactional Email Payment Request
    @When("I perform post operation on payment request")
    public void iPerformPostOperationOnPaymentRequest() throws IOException, ParseException {
        //post request to create Comment
        response = TransactionalEmailPaymentRequest(XMLModifier());
    }
